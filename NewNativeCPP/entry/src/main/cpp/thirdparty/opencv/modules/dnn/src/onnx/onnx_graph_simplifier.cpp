...
Mat getMatFromTensor(const opencv_onnx::TensorProto& tensor_proto)
{
    ...
    if (datatype == opencv_onnx::TensorProto_DataType_FLOAT) {
        ...
        if (!tensor_proto.float_data().empty()) {
            const ::google::cv_protobuf::RepeatedField<float> field = tensor_proto.float_data();
    ...
    {
        const ::google::cv_protobuf::RepeatedField<double> field = tensor_proto.double_data();
    ...
    else if (datatype == opencv_onnx::TensorProto_DataType_INT32)
    {
        ...
        {
            const ::google::cv_protobuf::RepeatedField<int32_t> field = tensor_proto.int32_data();
    ...
    else if (datatype == opencv_onnx::TensorProto_DataType_INT64)
    {
        ...
        if (!tensor_proto.int64_data().empty()) {
            ::google::cv_protobuf::RepeatedField< ::google::cv_protobuf::int64> src = tensor_proto.int64_data();
